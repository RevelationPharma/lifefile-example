...
const BooleanCheckbox: React.FC<BooleanCheckboxProps> = ({ checked, onCheckedChange }) => {
  const handleCheckedChange = (checked: boolean | undefined | "indeterminate") => {
...
export { Checkbox, BooleanCheckbox };
